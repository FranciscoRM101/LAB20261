...
int main()
{
	...
	PiernaDelantera1 = Model();
	PiernaDelantera1.LoadModel("Models/piernadelantera1.fbx");

	PiernaTrasera = Model();
	PiernaTrasera.LoadModel("Models/piernatrasera1.fbx");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// ARTICULACIÓN PIERNA Delantera 1 
		model = modelaux;
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		PiernaDelantera1.RenderModel();
	


		// ARTICULACIÓN PIERNA Delantera 2 
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.1f, 0.7f));
		...
		color = glm::vec3(0.2f, 0.2f, 0.2f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		PiernaTrasera.RenderModel();



		// ARTICULACIÓN PIERNA trasera 2 
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.5f, -0.5f, 0.7f));
